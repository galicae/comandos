...
`AnnData`, and `Pandas` DataFrames, so it should be relatively easy to
...
[Zenodo](https://doi.org/10.5281/zenodo.18740828).

### AI use

This code was partly generated with GitHub’s CoPilot, which was used to
fix bugs and correct linting/import/formatting issues via automatic
suggestions. To the best of my knowledge, I mostly used ChatGPT 5-miniO.
...
installation; in both cases, please remember to **not** use normal
Anaconda so as to avoid their licensing traps, and instead use whatever
[conda-forge](https://conda-forge.org/download/) are recommending.

The package was last tested with Python 3.14; it should work with
Python\>3.9, but there are no guarantees.
