...
# %% auto 0
__all__ = ['get_tarball', 'procrustes', 'grouped_obs_mean', 'grouped_obs_present', 'grouped_obs_percent', 'find_center',
           'map_fine_to_coarse']
...
def get_tarball():
    ...
    try:
        r = requests.get(URL)
        tarball = tarfile.open("example_data.tar.gz", "r:gz")
        tarball.extractall("../example_data")
        tarball.close()
    except HTTPError:
        print("URL not found")
    return
