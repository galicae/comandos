...
# %% auto #0
__all__ = ['procrustes', 'grouped_obs_mean', 'grouped_obs_present', 'grouped_obs_percent', 'rescale', 'find_center',
           'map_fine_to_coarse', 'collapse_unrelated_clusters']

# %% ../nbs/00_util.ipynb #e9745558
import os
import pickle
